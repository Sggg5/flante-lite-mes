...
新增迁移：`20260718_0002_add_excel_import_center_tables.py`，以及审查修复迁移 `20260718_0003_harden_phase_2_import_review_flows.py`。
...
- `python -m pytest -q`：`46 passed, 1 warning`，耗时 608.9 秒；警告为现有 FastAPI TestClient 上游弃用提示。
